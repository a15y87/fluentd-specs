...
BuildRequires:	rubygem(msgpack) < 0.6.0
...
BuildRequires:	rubygem(http_parser.rb) < 0.7.0
...
%changelog
* Fri Oct 21 2016 Andrey Bardin <a15y87@gmail.com> - 0.12.29-1
- Updated to upstream version 0.12.29
